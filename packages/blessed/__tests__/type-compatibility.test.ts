 ...
 *
 * This test verifies that @gavin-lynch/unblessed-blessed is 100% type-compatible with @types/blessed.
 * It ensures that code written for the original blessed library will work with @gavin-lynch/unblessed-blessed
