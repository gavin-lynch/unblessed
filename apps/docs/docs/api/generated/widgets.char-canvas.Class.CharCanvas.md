...
Defined in: [packages/core/src/widgets/char-canvas.ts:56](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L56)
...
> **new CharCanvas**(`options`): `CharCanvas`

Defined in: [packages/core/src/widgets/char-canvas.ts:62](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L62)

#### Parameters

##### options

[`CharCanvasOptions`](widgets.char-canvas.Interface.CharCanvasOptions.md)
...
> **type**: `string` = `"charcanvas"`

Defined in: [packages/core/src/widgets/char-canvas.ts:57](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L57)
...
> **setCell**(`x`, `y`, `char`, `attr`, `truecolorBg`, `truecolorFg`): `void`

Defined in: [packages/core/src/widgets/char-canvas.ts:116](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L116)
...
Terminal attribute code

##### truecolorBg

Optional truecolor background [r, g, b]

\[`number`, `number`, `number`\] | `null`

##### truecolorFg

Optional truecolor foreground [r, g, b]
...
> **getCell**(`x`, `y`): [`Cell`](widgets.cell.TypeAlias.Cell.md) \| `null`

Defined in: [packages/core/src/widgets/char-canvas.ts:142](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L142)
...
[`Cell`](widgets.cell.TypeAlias.Cell.md) \| `null`

Normalized cell [attr, ch, truecolorBg, truecolorFg] or null if out of bounds
...
> **clear**(`char`, `attr`, `truecolorBg`, `truecolorFg`): `void`

Defined in: [packages/core/src/widgets/char-canvas.ts:161](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L161)
...
Defined in: [packages/core/src/widgets/char-canvas.ts:178](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L178)
...
Defined in: [packages/core/src/widgets/char-canvas.ts:186](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L186)
...
> **drawLine**(`x0`, `y0`, `x1`, `y1`, `char`, `attr`): `void`

Defined in: [packages/core/src/widgets/char-canvas.ts:205](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L205)
...
> **drawRect**(`x`, `y`, `width`, `height`, `char`, `attr`, `fill`): `void`

Defined in: [packages/core/src/widgets/char-canvas.ts:259](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L259)
...
> **drawText**(`x`, `y`, `text`, `attr`): `void`

Defined in: [packages/core/src/widgets/char-canvas.ts:301](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L301)
...
Defined in: [packages/core/src/widgets/char-canvas.ts:311](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/char-canvas.ts#L311)
