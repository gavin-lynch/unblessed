...
Defined in: [packages/core/src/widgets/braille-canvas.ts:68](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L68)
...
> **new BrailleCanvas**(`options`): `BrailleCanvas`

Defined in: [packages/core/src/widgets/braille-canvas.ts:85](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L85)

#### Parameters

##### options

[`BrailleCanvasOptions`](widgets.braille-canvas.Interface.BrailleCanvasOptions.md)
...
> **type**: `string` = `"braillecanvas"`

Defined in: [packages/core/src/widgets/braille-canvas.ts:69](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L69)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:133](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L133)
...
X coordinate (0 to pixelWidth-1)

##### y

`number`

Y coordinate (0 to pixelHeight-1)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:166](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L166)
...
> **togglePixel**(`x`, `y`): `void`

Defined in: [packages/core/src/widgets/braille-canvas.ts:197](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L197)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:224](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L224)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:251](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L251)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:268](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L268)
...
> **drawRect**(`x`, `y`, `width`, `height`, `fill`): `void`

Defined in: [packages/core/src/widgets/braille-canvas.ts:310](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L310)
...
Top-left X (pixel coordinate)

##### y

`number`

Top-left Y (pixel coordinate)
...
> **drawCircle**(`cx`, `cy`, `radius`, `fill`): `void`

Defined in: [packages/core/src/widgets/braille-canvas.ts:346](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L346)
...
Whether to fill the circle (default: false)
...
> **plotFunction**(`fn`, `x0`, `x1`, `scaleX`, `scaleY`, `offsetY`): `void`

Defined in: [packages/core/src/widgets/braille-canvas.ts:410](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L410)
...
Y offset (default: pixelHeight/2)
...
```ts
// Plot sine wave
canvas.plotFunction((x) => Math.sin(x), 0, Math.PI * 2, 10, 10, 24);
```
...
> **getPixelDimensions**(): `object`

Defined in: [packages/core/src/widgets/braille-canvas.ts:442](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L442)
...
> **getCharDimensions**(): `object`

Defined in: [packages/core/src/widgets/braille-canvas.ts:454](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L454)
...
Defined in: [packages/core/src/widgets/braille-canvas.ts:465](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/braille-canvas.ts#L465)
