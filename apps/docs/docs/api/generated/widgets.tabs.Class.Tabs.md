...
Defined in: [packages/core/src/widgets/tabs.ts:40](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L40)
...
> **new Tabs**(`options`): `Tabs`

Defined in: [packages/core/src/widgets/tabs.ts:55](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L55)

#### Parameters

##### options

[`TabsOptions`](widgets.tabs.Interface.TabsOptions.md) = `\{\}`
...
Defined in: [packages/core/src/widgets/tabs.ts:41](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L41)
...
> **options**: [`TabsOptions`](widgets.tabs.Interface.TabsOptions.md)

Defined in: [packages/core/src/widgets/tabs.ts:42](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L42)
...
Defined in: [packages/core/src/widgets/tabs.ts:161](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L161)
...
Defined in: [packages/core/src/widgets/tabs.ts:165](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L165)

#### Parameters

##### tabs

[`TabItem`](widgets.tabs.Interface.TabItem.md)[]
...
Defined in: [packages/core/src/widgets/tabs.ts:174](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L174)
...
Defined in: [packages/core/src/widgets/tabs.ts:203](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/tabs.ts#L203)
