...
Defined in: [packages/core/src/widgets/gauge.ts:16](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L16)
...
Defined in: [packages/core/src/widgets/gauge.ts:17](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L17)
...
Defined in: [packages/core/src/widgets/gauge.ts:18](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L18)
...
Defined in: [packages/core/src/widgets/gauge.ts:19](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L19)
...
Defined in: [packages/core/src/widgets/gauge.ts:20](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L20)

---

### stack?

> `optional` **stack**: (`number` \| [`GaugeStackItem`](widgets.gauge.Interface.GaugeStackItem.md))[]

Defined in: [packages/core/src/widgets/gauge.ts:21](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L21)

---

### data?

> `optional` **data**: `number` \| (`number` \| [`GaugeStackItem`](widgets.gauge.Interface.GaugeStackItem.md))[]

Defined in: [packages/core/src/widgets/gauge.ts:22](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L22)
