...
Defined in: [packages/core/src/widgets/diff.ts:12](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L12)
...
> `optional` **oldContent**: `string`

Defined in: [packages/core/src/widgets/diff.ts:13](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L13)

---

### newContent?

> `optional` **newContent**: `string`

Defined in: [packages/core/src/widgets/diff.ts:14](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L14)

---

### oldFileName?

> `optional` **oldFileName**: `string`

Defined in: [packages/core/src/widgets/diff.ts:15](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L15)
...
Defined in: [packages/core/src/widgets/diff.ts:16](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L16)

---

### diffString?

> `optional` **diffString**: `string`

Defined in: [packages/core/src/widgets/diff.ts:17](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L17)
...
Defined in: [packages/core/src/widgets/diff.ts:18](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L18)

---

### additionColor?

> `optional` **additionColor**: `string` \| `number` \| `number`[] \| (`text`) => `string`

Defined in: [packages/core/src/widgets/diff.ts:19](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L19)

---

### deletionColor?

> `optional` **deletionColor**: `string` \| `number` \| `number`[] \| (`text`) => `string`

Defined in: [packages/core/src/widgets/diff.ts:20](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L20)

---

### contextColor?

> `optional` **contextColor**: `string` \| (`text`) => `string`

Defined in: [packages/core/src/widgets/diff.ts:21](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L21)

---

### headerColor?

> `optional` **headerColor**: `string` \| (`text`) => `string`

Defined in: [packages/core/src/widgets/diff.ts:22](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L22)
...
Defined in: [packages/core/src/widgets/diff.ts:23](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L23)

---

### syntaxHighlight?

> `optional` **syntaxHighlight**: `boolean`

Defined in: [packages/core/src/widgets/diff.ts:24](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L24)
...
Defined in: [packages/core/src/widgets/diff.ts:25](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L25)

---

### highlightTheme?

> `optional` **highlightTheme**: `Record`\<`string`, `string` \| `string`[] \| (`text`) => `string`\>

Defined in: [packages/core/src/widgets/diff.ts:26](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L26)
