...
Defined in: [packages/core/src/widgets/gauge.ts:25](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L25)
...
> **new Gauge**(`options`): `Gauge`

Defined in: [packages/core/src/widgets/gauge.ts:33](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L33)

#### Parameters

##### options

[`GaugeOptions`](widgets.gauge.Interface.GaugeOptions.md) = `\{\}`
...
Defined in: [packages/core/src/widgets/gauge.ts:26](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L26)
...
> **options**: [`GaugeOptions`](widgets.gauge.Interface.GaugeOptions.md)

Defined in: [packages/core/src/widgets/gauge.ts:27](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L27)
...
Defined in: [packages/core/src/widgets/gauge.ts:54](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L54)
...
Defined in: [packages/core/src/widgets/gauge.ts:62](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L62)
...
Defined in: [packages/core/src/widgets/gauge.ts:71](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L71)
...
Defined in: [packages/core/src/widgets/gauge.ts:102](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L102)

#### Parameters

##### stack

(`number` \| [`GaugeStackItem`](widgets.gauge.Interface.GaugeStackItem.md))[]
...
> **getOptionsPrototype**(): [`GaugeOptions`](widgets.gauge.Interface.GaugeOptions.md)

Defined in: [packages/core/src/widgets/gauge.ts:166](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge.ts#L166)
