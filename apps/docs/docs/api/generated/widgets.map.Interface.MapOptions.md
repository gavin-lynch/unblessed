...
Defined in: [packages/core/src/widgets/map.ts:20](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L20)
...
Defined in: [packages/core/src/widgets/map.ts:21](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L21)

---

### endLon?

> `optional` **endLon**: `number`

Defined in: [packages/core/src/widgets/map.ts:22](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L22)
...
Defined in: [packages/core/src/widgets/map.ts:23](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L23)

---

### endLat?

> `optional` **endLat**: `number`

Defined in: [packages/core/src/widgets/map.ts:24](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L24)
...
Defined in: [packages/core/src/widgets/map.ts:25](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L25)

---

### excludeAntarctica?

> `optional` **excludeAntarctica**: `boolean`

Defined in: [packages/core/src/widgets/map.ts:26](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L26)
...
Defined in: [packages/core/src/widgets/map.ts:27](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L27)

---

### disableMapBackground?

> `optional` **disableMapBackground**: `boolean`

Defined in: [packages/core/src/widgets/map.ts:28](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L28)

---

### disableGraticule?

> `optional` **disableGraticule**: `boolean`

Defined in: [packages/core/src/widgets/map.ts:29](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L29)

---

### disableFill?

> `optional` **disableFill**: `boolean`

Defined in: [packages/core/src/widgets/map.ts:30](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L30)

---

### labelSpace?

> `optional` **labelSpace**: `number`

Defined in: [packages/core/src/widgets/map.ts:31](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L31)
...
Defined in: [packages/core/src/widgets/map.ts:32](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L32)
...
> `optional` **markers**: [`MapMarker`](widgets.map.Interface.MapMarker.md)[]

Defined in: [packages/core/src/widgets/map.ts:37](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L37)

---

### mapPaddingX?

> `optional` **mapPaddingX**: `number`

Defined in: [packages/core/src/widgets/map.ts:38](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/map.ts#L38)
