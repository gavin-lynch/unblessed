...
Defined in: [packages/core/src/widgets/gauge-list.ts:30](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L30)
...
> **new GaugeList**(`options`): `GaugeList`

Defined in: [packages/core/src/widgets/gauge-list.ts:39](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L39)

#### Parameters

##### options

[`GaugeListOptions`](widgets.gauge-list.Interface.GaugeListOptions.md) = `\{\}`
...
> **type**: `string` = `"gauge-list"`

Defined in: [packages/core/src/widgets/gauge-list.ts:31](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L31)
...
> **options**: [`GaugeListOptions`](widgets.gauge-list.Interface.GaugeListOptions.md)

Defined in: [packages/core/src/widgets/gauge-list.ts:32](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L32)
...
> **gauges**: [`GaugeListItem`](widgets.gauge-list.Interface.GaugeListItem.md)[] = `[]`

Defined in: [packages/core/src/widgets/gauge-list.ts:33](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L33)
...
Defined in: [packages/core/src/widgets/gauge-list.ts:55](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L55)
...
Defined in: [packages/core/src/widgets/gauge-list.ts:63](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L63)
...
> **setGauges**(`gauges`): `void`

Defined in: [packages/core/src/widgets/gauge-list.ts:67](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L67)

#### Parameters

##### gauges

[`GaugeListItem`](widgets.gauge-list.Interface.GaugeListItem.md)[]
...
> **getOptionsPrototype**(): [`GaugeListOptions`](widgets.gauge-list.Interface.GaugeListOptions.md)

Defined in: [packages/core/src/widgets/gauge-list.ts:140](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L140)
