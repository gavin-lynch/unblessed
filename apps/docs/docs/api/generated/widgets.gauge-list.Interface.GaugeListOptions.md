...
Defined in: [packages/core/src/widgets/gauge-list.ts:21](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L21)
...
Defined in: [packages/core/src/widgets/gauge-list.ts:22](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L22)
...
Defined in: [packages/core/src/widgets/gauge-list.ts:23](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L23)
...
Defined in: [packages/core/src/widgets/gauge-list.ts:24](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L24)

---

### gaugeSpacing?

> `optional` **gaugeSpacing**: `number`

Defined in: [packages/core/src/widgets/gauge-list.ts:25](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L25)

---

### gaugeHeight?

> `optional` **gaugeHeight**: `number`

Defined in: [packages/core/src/widgets/gauge-list.ts:26](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L26)

---

### gauges?

> `optional` **gauges**: [`GaugeListItem`](widgets.gauge-list.Interface.GaugeListItem.md)[]

Defined in: [packages/core/src/widgets/gauge-list.ts:27](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/gauge-list.ts#L27)
