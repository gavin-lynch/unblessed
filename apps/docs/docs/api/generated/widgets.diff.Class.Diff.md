...
Defined in: [packages/core/src/widgets/diff.ts:32](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L32)
...
> **new Diff**(`options`): `Diff`

Defined in: [packages/core/src/widgets/diff.ts:37](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L37)

#### Parameters

##### options

[`DiffOptions`](widgets.diff.Interface.DiffOptions.md) = `\{\}`
...
Defined in: [packages/core/src/widgets/diff.ts:33](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L33)
...
> **options**: [`DiffOptions`](widgets.diff.Interface.DiffOptions.md)

Defined in: [packages/core/src/widgets/diff.ts:34](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L34)
...
> **setDiff**(`diffString`): `void`

Defined in: [packages/core/src/widgets/diff.ts:726](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L726)
...
> **setDiffContent**(`oldContent`, `newContent`): `void`

Defined in: [packages/core/src/widgets/diff.ts:732](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L732)
...
> **setFileNames**(`oldFileName`, `newFileName`): `void`

Defined in: [packages/core/src/widgets/diff.ts:741](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/diff.ts#L741)
