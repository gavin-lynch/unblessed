...
Defined in: [packages/core/src/widgets/canvas.ts:72](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/canvas.ts#L72)
...
- [`Bar`](widgets.bar.Class.Bar.md)
- [`Donut`](widgets.donut.Class.Donut.md)
- [`GaugeList`](widgets.gauge-list.Class.GaugeList.md)
- [`Gauge`](widgets.gauge.Class.Gauge.md)
- [`LCD`](widgets.lcd.Class.LCD.md)
- [`LineChart`](widgets.linechart.Class.LineChart.md)
- [`WorldMap`](widgets.map.Class.WorldMap.md)
- [`StackedBar`](widgets.stacked-bar.Class.StackedBar.md)

## Constructors

### Constructor

> **new CanvasWidget**(`options`, `canvasType`): `CanvasWidget`

Defined in: [packages/core/src/widgets/canvas.ts:99](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/canvas.ts#L99)
...
`CanvasConstructor` = `DrawilleCanvas`
...
Defined in: [packages/core/src/widgets/canvas.ts:73](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/canvas.ts#L73)
...
Defined in: [packages/core/src/widgets/canvas.ts:226](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/canvas.ts#L226)
