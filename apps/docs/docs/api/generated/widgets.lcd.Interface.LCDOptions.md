...
Defined in: [packages/core/src/widgets/lcd.ts:11](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L11)
...
> `optional` **segmentWidth**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:12](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L12)

---

### segmentInterval?

> `optional` **segmentInterval**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:13](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L13)
...
Defined in: [packages/core/src/widgets/lcd.ts:14](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L14)
...
Defined in: [packages/core/src/widgets/lcd.ts:15](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L15)
...
Defined in: [packages/core/src/widgets/lcd.ts:16](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L16)

---

### elementSpacing?

> `optional` **elementSpacing**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:17](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L17)

---

### elementPadding?

> `optional` **elementPadding**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:18](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L18)

---

### color?

> `optional` **color**: `string` \| `number` \| `number`[]

Defined in: [packages/core/src/widgets/lcd.ts:19](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L19)

---

### canvasPaddingX?

> `optional` **canvasPaddingX**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:20](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L20)

---

### canvasPaddingY?

> `optional` **canvasPaddingY**: `number`

Defined in: [packages/core/src/widgets/lcd.ts:21](https://github.com/gavin-lynch/unblessed/blob/main/packages/core/src/widgets/lcd.ts#L21)
