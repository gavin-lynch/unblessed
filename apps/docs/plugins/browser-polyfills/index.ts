...
/**
 * Docusaurus client bundle imports `@unblessed/browser`, which re-exports all of
 * `@unblessed/core`. Some widgets pull Node-only transitive deps (markdown/picture/etc.).
